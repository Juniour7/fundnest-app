...
import { getMonthlyTransactionDetails } from "./services/TransactionService";

const MonthlyProgressForTransactions = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const progress = await getMonthlyTransactionDetails();
    ...
    return (
        <div className='border-2 rounded-lg p-4 shadow-lg hover:shadow-xl transition duration-300'>
            ...
            {/* <div className="mt-4">
                <h3 className="text-lg font-semibold mb-2">Detailed Monthly Transactions for admin</h3>
...
export default MonthlyProgressForTransactions;
