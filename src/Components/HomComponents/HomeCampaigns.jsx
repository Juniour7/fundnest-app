  ...
  return (
    <>
      <section className='font-sen'>
        <div id='campaign' className="w-[90%] md:w-[98%] mx-auto">
          <div className='my-7 '>
            <h1 className='text-[#00AEEF] t text-xl md:text-3xl font-semibold'>You can help lots of people by donating little</h1>
            <p className='my-3 text-base'>These campaigns need your help to achieve victory.</p>
            <button className='bg-[#00AEEF] text-white px-4 py-2 text-base md:text-lg rounded-lg'>Popular Campaigns</button>
          </div>
      ...
      <div className="w-[90%] md:w-[98%] mx-auto">
        <button className='bg-[#00AEEF] text-white px-4 py-2 text-lg md:text-xl rounded-lg my-5'>Latest Campaigns</button>
